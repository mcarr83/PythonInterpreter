...
//Added for functionality of for loop

class ForLoop : public Statement{
public:
    ForLoop();
    ForLoop(AssignmentStatement *initVar, ExprNode *condExpr, AssignmentStatement *varUpdate, Statements *stmts);
...
// For functionality of keyword print
