...
TypeDescriptor* operator || (TypeDescriptor left, TypeDescriptor right){
    switch(left.type()){
        case TypeDescriptor::NUMBER:
            ...
            break;
        case TypeDescriptor::STRING:{
            std::cout << "Attempted or on a string" << std::endl;
            std::cout << '"' << left._s << "\" and \"" << right._s << std::endl;}
            exit(20);
            break;
        default:
...
TypeDescriptor* operator && (TypeDescriptor left, TypeDescriptor right){
    switch(left.type()){
        case TypeDescriptor::NUMBER:
            ...
            break;
        case TypeDescriptor::STRING:{
            std::cout << "Attempted and on a string" << std::endl;
            std::cout << '"' << left._s << "\" and \"" << right._s << std::endl;}
            exit(21);
            break;
        default:
...
TypeDescriptor* operator ! (TypeDescriptor right){
    switch(right.type()){
        case TypeDescriptor::NUMBER:
            if (!right._n)
                return new NumDescriptor(1.0);
            ...
            break;
        case TypeDescriptor::STRING:{
            std::cout << "Attempted not on a string" << std::endl;
            std::cout << right._s << std::endl;}
            exit(22);
            break;
        default:
            std::cout << "Unknown type, exiting..." << std::endl;
